...
//constants to request url and headers
...
// onAnalyzeButtonClick() function will work when a button is pressed
...
// analyzeComment() function will create a request based on the text entered by the user
...
// handleEmptyComment() function will run if the user has not entered anything and pressed the button
...
// function that we pass as a callback to analyzeComment function
// , it displays result to the user.
